...
- **THEN** the home-movies server SHALL be running and accessible at `localhost:3000` within 30 seconds
...
- **THEN** the server SHALL be accessible at `localhost:3000` again within 5 seconds
