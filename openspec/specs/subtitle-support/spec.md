...
This applies to both newly-downloaded movies (via torrent) and movies already in the library.
...
#### Scenario: Library movie subtitles
- **WHEN** a movie already in the library is played and has an IMDb ID
- **THEN** subtitles SHALL be fetched and displayed the same as for a newly-streamed movie
